'use strict';
// Webhooks públicos da Meta. Cada canal tem uma URL própria e secreta (/api/webhooks/whatsapp/<chave>),
// o que identifica a empresa antes de qualquer acesso aos dados dela.
const express = require('express');
const { query, runAsSystem, runAsCompany } = require('../db');
const { decrypt } = require('../lib/crypto');
const whatsapp = require('../lib/whatsapp');
const { processWebhookValue } = require('../lib/inbox');
...
// Verificação da assinatura do webhook (feita pela Meta ao configurar a URL)
router.get('/whatsapp/:key', async (req, res, next) => {
  try {
